...
(2) Browse and find the usb-driver-win32 directory in the PyATK distribution
    or checkout.  Select this folder and click "Next".

(3) On 64-bit machines, a warning will display that "Windows can't verify
...
(4) Windows should successfully install the driver and identify your
